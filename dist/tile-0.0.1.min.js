define([ "jQuery", "Underscore", "Backbone" ], function(a, b, c) {
    ...
    BIG = 1e5, emptyStr = function(a) {
        ...
        function e(a, b, c) {
            var e = "";
            a & d.JOB_RENDER && (e += " JOB_RENDER"), a & d.JOB_PRUNE && (e += " JOB_PRUNE"), 
            a & d.JOB_PRESIZE && (e += " JOB_PRESIZE"), a & d.JOB_TRACE && (e += " JOB_TRACE"), 
            console.log("REFLOW.schedule(", e, ",", b.cid, ")"), b.flowJobs & a || (b.flowJobs |= a, 
            k[a].jobs.push(b), j++), c || f();
        }
        function f() {
            if (!i && !h && j) {
                for (h = 3; h-- && j; ) {
    ...
    return h.prototype = {
        ...
        prepTile: function(a, c) {
            if (c instanceof jQuery ? c = {
                type: d.Dragger,
                spawner: this.origin,
                dragData: this
            } : c instanceof d.View && this.copyable && (c = c.get()), b.isObject(c)) {
                var e = c.$el.offset();
                return a.addView(c, void 0, {
                    mode: "offset",
                    width: c.$el.width(),
                    height: c.$el.height(),
                    x: this.tileX = e.left,
