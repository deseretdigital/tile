(function() {
    function a(a, b, c) {
        ...
        d.JOB_PRUNE = JOB_PRUNE = 1, d.JOB_RENDER = JOB_RENDER = 2, d.JOB_PRESIZE = JOB_PRESIZE = 4, 
        ...
        BIG = 1e5, emptyStr = function(a) {
            ...
            function h(a, b) {
                ...
                for (var g in b) {
                    var h = b[g];
                    a.options[g] != h && ((c = l[g]) ? f += k(g, a, c, h) : e && (c = e[g]) ? f += k(g, a, c, h) : a.optionBuffer[g] = h);
                }
                return f;
            }
            function i() {}
            function j(a, b) {
                ...
                for (c in i) e = i[c], void 0 !== (d = g[c]) ? (k(c, a, e, d), delete g[c]) : void 0 === f[c] && void 0 !== (d = e.defaultValue) && k(c, a, e, d, !0);
            }
            function k(a, b, c, e, f) {
                var g, h, i;
                return !f && (g = c.input) && (e = g(e)), c.setter.call(b, e), (h = c.flowFlags) && (b.flowFlags |= h), 
                (i = c.flowJobs) && d.reflow.schedule(i, b, !0), 1;
            }
            var l = {}, m = {};
            return f(a), f(c, !0), {
                extend: e,
        ...
        return h.prototype = {
            ...
            prepTile: function(a, b) {
                var c = b instanceof d.View, e = c ? b.$el : b;
                (!c || this.copyable) && (b = {
                    type: d.Dragger,
                    spawner: this.origin,
                    dragData: this
            ...
            zoneInit: function(a, c, d) {
                if (this.options.drop && this != c.tile && this.dropInit(a, c)) {
            ...
            close: function(a) {
                this._isRunning && (this._isRunning = !1, this.type = null, d.reflow.block(), this.despawn(a), 
                this.detachThis(), this.setViews(), d.reflow.unblock());
            },
            _configure: function(a) {
                ...
                this.optionBuffer = a, this.options = {}, this.childViews = [], this.spawnedViews = [];
            },
            ...
            traceBubble: function(a, b, c) {
                b.flowFlags & FLOW_TRACED || (b.flowFlags |= FLOW_TRACED, this.flowViews ? this.flowViews.push(b) : this.flowViews = [ b ]), 
            ...
            dropFinish: function() {},
            setClickout: function(a) {
                var c = d.clickoutViews;
                a != this._isClickout && ((this._isClickout = a) ? c.push(this) : c = b.without(c, this));
            },
            isClickIn: function() {
                var a, b = null;
                return this._isClickout && (b = this), this.parent && (a = this.parent.isClickIn()) && (b = a), 
                this.spawnerView && (a = this.spawnerView.isClickIn()) && (b = a), b;
            },
            onClickout: function() {},
            setSpawner: function(a) {
                this.spawnerView && this.spawnerView.despawn(this), a && (this.spawnerView = a, 
                a.spawnedViews.push(this));
            },
            spawn: function(a) {
                d.root.addView(a, void 0, {
                    mode: "target",
                    target: this.$el,
                    spawner: this
                });
            ...
            despawn: function(a) {
                var c;
                if (a instanceof d.View) this.spawnedViews = b.without(this.spawnedViews, a), a.spawnerView = null; else {
                    for (;c = this.spawnedViews.pop(); ) c.spawnerView = null, a === !0 && c.close();
                    this.spawnerView && this.spawnerView.despawn(this);
                }
            },
            ...
            _configure: function() {
                this.optionBuffer = {}, this.options = {}, this.childViews = [];
            },
    ...
    if ("undefined" != typeof define && define.amd) define([ "jquery", "underscore", "backbone" ], function(b, c, d) {
        return console.log(b, c, d), a(b, c, d);
    }); else if ("undefined" != typeof exports) {
        var b = require("jquery"), c = require("_"), d = require("backbone");
        module || (module = {}), exports = module.exports = a(b, c, d);
    } else this.Tile = a(this.jQuery, this._, this.Backbone);
}).call(this);