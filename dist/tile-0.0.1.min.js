define([ "jQuery", "Underscore", "Backbone" ], function(a, b, c) {
    ...
    var h = d.Dragdrop = function(b) {
        ...
        for (console.log("DRAGDROP", e.cid), this.tile = c[0] == d[0] ? e : c, this.origin = e, 
        this.target = c, this.startX = b.pageX, this.startY = b.pageY, this.zones = []; e && !e.dragInit(b, this); ) e = e.parentView;
