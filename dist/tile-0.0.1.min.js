define([ "jQuery", "Underscore", "Backbone" ], function(a, b, c) {
    JOB_PRUNE = 1, JOB_PRESIZE = 2, JOB_TRACE = 4, JOB_RENDER = 8, FLOW_LOCAL = 1, FLOW_SUPER = 2, 
    FLOW_SIZED = 4, FLOW_STYLED = 8, FLOW_RENDERED = 16, FLOW_ADDED = 32, FLOW_MEASURED = 64, 
    FLOW_VIEWS = 128, FLOW_TRACED = 256, SUPER_ADDED = FLOW_SUPER + FLOW_ADDED, STYLED_ADDED = FLOW_STYLED + FLOW_ADDED, 
    ...
    return h.prototype = {
        ...
        _toView: function(a, c) {
            ...
            b.isString(a.type) && (e = d.Views[a.type]), b.isFunction(e) || (e = d.Loader)), 
            new e(a).render());
        },
        detachThis: function() {
        ...
        initialize: function(a) {
            var b = this;
            require([ "tile!" + a.type ], function(c) {
                b.replaceWith(new c(a));
            }, function(c) {
