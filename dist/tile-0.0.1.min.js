define([ "jQuery", "Underscore", "Backbone" ], function(a, b, c) {
    JOB_PRUNE = 1, JOB_PRESIZE = 2, JOB_TRACE = 4, FLOW_LOCAL = 1, FLOW_SUPER = 2, FLOW_SIZED = 4, 
    FLOW_STYLED = 8, FLOW_RENDERED = 16, FLOW_ADDED = 32, FLOW_MEASURED = 64, FLOW_VIEWS = 128, 
    FLOW_TRACED = 256, SUPER_ADDED = FLOW_SUPER + FLOW_ADDED, STYLED_ADDED = FLOW_STYLED + FLOW_ADDED, 
    SUPER_ADDED_RENDERED_SIZED = SUPER_ADDED + FLOW_RENDERED + FLOW_SIZED, STRING_BOOLEAN = {
        "false": !1,
        no: !1,
        off: !1,
        "null": !1,
    ...
    var d = window.Tile = {
        Views: {}
    }, e = [ "el", "id", "attributes", "className", "tagName", "events" ], f = Math.abs, g = (Math.round, 
    ...
    BIG = 1e5, emptyStr = function(a) {
        ...
        function f() {
            if (!i && !h && j) {
                for (console.time("DOM_REFLOW_TIME"), h = 3; h-- && j; ) {
                    for (var a in k) g(a, k[a]);
                    (d.root.flowViews || d.root.flowFlags) && d.root.flow();
                }
                h || (console.error("Reflow Dispatch Cycle Overflow"), console.trace()), h = 0, 
                b.defer(function() {
        ...
        function d(a) {
            return {
                scrollWidth: a.$el.width(),
                scrollHeight: a.$el.height()
            };
        }
        function e(a) {
            return {
    ...
    var h = d.Dragdrop = function(b) {
        ...
        this.startY = b.pageY, this.zones = []; !e.dragInit(b, this); ) e = e.parent;
    ...
    return h.prototype = {
        ...
        move: function(a, b) {
            ...
            this.autodrag && this.tile.isType(Dragger) && (this.copyable || this.committed ? this.tile.close() : this.restorable && this.tile.dragRestore()), 
        ...
        zoneInit: function(a, c, d) {
            ...
            } else b.each(this.tiles, function(b) {
        ...
        debug: function(a) {
            ...
            "dash/widget" != this.type) for (var b = 0, c = this.childViews.length; c > b; b++) this.childViews[b].debug(a + 2);
        },
        getViews: function() {
        ...
        indexOf: function(a) {
            return b.indexOf(this.childViews.length, a);
        },
        ...
        _toView: function(a, c) {
            ...
            a = c) : (b.isObject(a) || (a = {
                type: a
            }), b.isObject(c) && (a = b.extend({}, a, c)), b.isString(a.type) && (e = d.Views[a.type]), 
            b.isFunction(e) || (e = d.Loader)), new e(a).render());
        },
        detachThis: function() {
            this.parentView && this.parentView.detachView(this);
        },
        detachView: function(a) {
            a.parent = null, a.$el.detach(), this.childViews = b.without(this.childViews, a), 
            this.setFlag(FLOW_VIEWS);
        },
        replaceWith: function(a) {
            this.parentView && (d.reflow.block(), this.parentView.addView(a, this.parentView.indexOf(this)), 
            this.detachThis(), d.reflow.unblock());
        },
        findView: function(a) {
        ...
        traceView: function() {
            this.flowFlags & STYLED_ADDED && this.measurePad(), this.traceChange(this, null, 0), 
            this.parentView && (this.flowFlags & SUPER_ADDED && (this.parentView.flowFlags |= FLOW_VIEWS), 
